 ...
 * U+0307 COMBINING DOT ABOVE: try adding one of: canadian-aboriginal, tai-le, math, tifinagh, old-permic, coptic, malayalam, syriac
 ...
 * U+2010 HYPHEN: try adding one of: syloti-nagri, lisu, sundanese, yi, kayah-li, coptic, sora-sompeng, kharoshthi, cham, kaithi
...
Your font does *not* cover the following languages that require the soft-dotted feature: Ejagham (Latn, 120,000 speakers), Nateni (Latn, 100,000 speakers), Kom (Latn, 360,685 speakers), Koonzime (Latn, 40,000 speakers), Lugbara (Latn, 2,200,000 speakers), Ebira (Latn, 2,200,000 speakers), Aghem (Latn, 38,843 speakers), Avokaya (Latn, 100,000 speakers), Belarusian (Cyrl, 10,064,517 speakers), Dan (Latn, 1,099,244 speakers), Igbo (Latn, 27,823,640 speakers), Basaa (Latn, 332,940 speakers), Ukrainian (Cyrl, 29,273,587 speakers), Ma’di (Latn, 584,000 speakers). [code: soft-dotted]
