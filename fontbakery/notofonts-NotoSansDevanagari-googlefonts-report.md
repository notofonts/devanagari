...
* 🔥 **FAIL** OS/2.usWinDescent value should be equal or greater than 530, but got 408 instead [code: descent]
 ...
 * U+0307 COMBINING DOT ABOVE: try adding one of: syriac, coptic, tai-le, malayalam, tifinagh, canadian-aboriginal, old-permic, math
 ...
 * U+2010 HYPHEN: try adding one of: coptic, kaithi, syloti-nagri, sora-sompeng, kharoshthi, cham, kayah-li, lisu, sundanese, yi
...
* ⚠ **WARN** The following spacing glyphs may be in the GDEF mark glyph class by mistake:
	 reversedVisargaAnudattavedic (U+1CE6), reversedVisargaUdattavedic (U+1CE4), visargaAnudattaTailvedic (U+1CE8), visargaAnudattavedic (U+1CE5), visargaUdattaTailvedic (U+1CE7) and visargaUdattavedic (U+1CE3) [code: spacing-mark-glyphs]
</div></details><details><summary>⚠ <b>WARN:</b> Check mark characters are in GDEF mark glyph class. (<a href="https://font-bakery.readthedocs.io/en/stable/fontbakery/profiles/gdef.html#com.google.fonts/check/gdef_mark_chars">com.google.fonts/check/gdef_mark_chars</a>)</summary><div>


* ⚠ **WARN** The following mark characters could be in the GDEF mark glyph class:
	 rigvedicKashmiriIndependentSvaritavedic (U+1CE0) [code: mark-chars]
...
Your font does *not* cover the following languages that require the soft-dotted feature: Mango (Latn, 77,000 speakers), Basaa (Latn, 332,940 speakers), Ijo, Southeast (Latn, 2,471,000 speakers), Aghem (Latn, 38,843 speakers), Lugbara (Latn, 2,200,000 speakers), Ukrainian (Cyrl, 29,273,587 speakers), Dan (Latn, 1,099,244 speakers), Gulay (Latn, 250,478 speakers), Kom (Latn, 360,685 speakers), Igbo (Latn, 27,823,640 speakers), Makaa (Latn, 221,000 speakers), Sar (Latn, 500,000 speakers), Fur (Latn, 1,230,163 speakers), Mundani (Latn, 34,000 speakers), Yala (Latn, 200,000 speakers), Bafut (Latn, 158,146 speakers), Belarusian (Cyrl, 10,064,517 speakers), Ma’di (Latn, 584,000 speakers), Ngbaka (Latn, 1,020,000 speakers), Nzakara (Latn, 50,000 speakers), Ekpeye (Latn, 226,000 speakers), Ejagham (Latn, 120,000 speakers), Mfumte (Latn, 79,000 speakers), South Central Banda (Latn, 244,000 speakers), Ebira (Latn, 2,200,000 speakers), Kpelle, Guinea (Latn, 622,000 speakers), Avokaya (Latn, 100,000 speakers), Southern Kisi (Latn, 360,000 speakers), Cicipu (Latn, 44,000 speakers), Zapotec (Latn, 490,000 speakers), Bete-Bendi (Latn, 100,000 speakers), Koonzime (Latn, 40,000 speakers), Nateni (Latn, 100,000 speakers), Dii (Latn, 71,000 speakers). [code: soft-dotted]
